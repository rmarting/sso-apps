...
<br/><br/>
<a href="" onclick="showAlert('Testing JavaScript')">Click here to test JavaScript Functions</a><br/>




<a href="<%= request.getContextPath() %>/secure/version" onclick="">Secure Zone</a>
<%
